...
## Project Structure
    ...
    ├── solitary_breeze_dev_94793  # Django project configurations
...
1. Clone this repo and `cd solitary_breeze_dev_94793`
...
2. Clone this repo and `cd solitary_breeze_dev_94793`
